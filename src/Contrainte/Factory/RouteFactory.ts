...
export interface RouteFactoryAci {
  createGetRoute(route: string, action: string, controller: any): any;
  createPostRoute(route: string, action: string, controller: any): any;
  createPutRoute(route: string, action: string, controller: any): any;
  createDeleteRoute(route: string, action: string, controller: any): any;
}
